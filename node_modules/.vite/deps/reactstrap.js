...
function addDefaultProps(defaultProps14, props) {
  if (!defaultProps14 || !props) return props;
...
function getChildMapping(children2, mapFn) {
  ...
  if (children2) import_react28.Children.map(children2, function(c) {
    return c;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (!(0, import_react28.isValidElement)(child)) return;
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react30.default.Children.count(props[propName]) !== 2) return new Error('"' + propName + '" must be exactly two transition components.');
    return null;
  }
} : {};
  ...
  _createClass14(Modal2, [{
    ...
    value: function trapFocus(ev) {
      ...
      for (var i = 0; i < children2.length; i += 1) {
        if (children2[i] === ev.target) return;
      }
